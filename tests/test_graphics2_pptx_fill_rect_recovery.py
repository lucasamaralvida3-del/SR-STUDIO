...
def test_recovers_exact_shape_and_picture_fill_rect_contracts(tmp_path):
    ...
    # O shape chega com um valor plausível, porém incorreto: uma auditoria por
    # contagem antiga diria 100%, enquanto o contrato exato deve corrigi-lo.
...
def test_explicit_zero_fill_rect_is_preserved_as_a_real_contract(tmp_path):
    ...
    # Sem fill_rect no node: o contrato explícito 0/0/0/0 da Picture precisa
    # ser materializado e não descartado como dicionário vazio.
