...
async function importPptx(file){
  ...
  if(full){A.setStatus('PPTX: design completo preservado · '+(data.slotCount||0)+' bloco(s)');A.toast((data.pageCount||0)+' página(s) do Canva importada(s) com design completo')}
