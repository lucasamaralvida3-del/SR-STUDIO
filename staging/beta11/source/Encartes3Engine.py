...
class _QuietHandler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if parsed.path=='/api/encartes/health': return self._json({'ok':True,'product_db':PRODUCT_DB.is_file(),'version':'4.0.10-beta11'})
...
class Encartes3Panel(tk.Frame):
    def __init__(self,parent,app=None,pal=None):
        ...
        tk.Label(body,text='BETA 11 • NOVO EDITOR OFICIAL',bg=bg,fg=blue,font=('Segoe UI',10,'bold')).pack()
