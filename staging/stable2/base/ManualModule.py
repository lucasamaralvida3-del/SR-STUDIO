...
from SRStudio21 import dated_output_dir, smart_pdf_name, unique_path, record_reprint, record_product_jobs, PRODUCT_DB, norm
...
class ManualPanel(tk.Frame):
    ...
    def promo_job(self):
        ...
        headline=self.headline.get().strip().upper() if tipo in {1,2} else "CLUBE SR"
    ...
    def atacado_poster(self):
        ...
        p["nome"]=str(p.get("nome") or "").strip().upper()
